...
export const metadata: Metadata = {
  title: {
    absolute: "【騎手・厩務員になるには】馬の学校・馬の高校比較。人気の学校なら",
  },
  description:
    "騎手・厩務員になるには、中学卒業後は、馬と毎日過ごしながら高校の卒業を目指せるバジガク（東関東馬事高等学院）が評判。口コミ。120頭以上の馬たちが過ごす人気の馬の学校・馬の高校です。馬の高校ならではの実践教育をご紹介します。【騎手・厩務員・競走馬を学ぶならココ】",
  keywords: [
    "馬の高校",
    "馬の学校",
    "馬と学ぶ高校",
