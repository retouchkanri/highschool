...
export const metadata: Metadata = {
  title: {
    absolute: "馬の学校見学・オープンキャンパス（馬の学校 比較）｜JRA厩務員・競馬学校を目指す高校｜東関東馬事高等学院",
  },
  description:
    "JRA厩務員・競馬学校・騎手・馬の仕事を目指す中学生、高校生へ。東関東馬事高等学院の学校見学・オープンキャンパスでは、実際の馬とのふれあいや乗馬体験、厩舎・学生寮の見学、授業・進路・学費の説明まで1日で体験できます。未経験者・保護者の参加も歓迎。JR東京駅から無料送迎あり",
  keywords: [
    "馬の学校",
    "馬の高校",
    "オープンキャンパス",
