...
export const metadata: Metadata = {
  title: {
    absolute: "中学生から騎手を目指す｜JRA騎手受験の方の事前合宿｜参加者申込受付中",
  },
  description:
    "中学生のための騎手受験合宿なら｜騎手を目指す中学生のための騎手受験事前合宿。騎乗、体力、体重管理などを実践し、JRA競馬学校・地方競馬教養センターの騎手課程受験に向けて準備します。一次試験内容、二次試験内容。JRA競馬学校の騎手課程受験内容。試験内容一覧（参照）",
  keywords: [
    "騎手 中学生",
    "JRA騎手 中学生",
    "騎手になるには 中学生",
