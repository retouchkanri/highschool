...
export const metadata: Metadata = {
  title: {
    absolute: "中学3年生対象／騎手になるには｜JRA競馬学校 騎手課程・中3受験対策合宿｜東関東馬事高等学院",
  },
  description:
    "JRA競馬学校・地方競馬教養センターの騎手課程を受験する中学3年生対象。6泊7日の騎手受験事前合宿で、筆記試験、運動機能検査、面接、騎乗試験を実践的に対策します。騎手課程合格者38名を輩出してきた東関東馬事高等学院が、初めての騎手受験をサポートします。",
  keywords: [
    "JRA競馬学校",
    "JRA競馬学校騎手課程",
    "騎手課程",
