...
export const metadata: Metadata = {
  title: {
    absolute: "馬の学校／学費で比較！馬の高校の入学・学費・募集要項｜馬の学校 比較",
  },
  description:
    "馬の高校・東関東馬事高等学院の募集要項。入学資格、学費、寮生活、出願方法などをご案内。乗馬未経験からでも馬を学び、馬業界への進路を目指せる全寮制の馬の高校です。関東・関西で人気の馬事学院では、引退馬支援団体Retouchとの連携で120頭を超える馬たちが在籍しています。",
  keywords: [
    "JRA",
    "競馬学校",
    "騎手",
...
const supports = [
  ...
  },
  {
    en: "SUBSIDY",
    title: "高等学校等就学支援金",
    desc: "連携する広域通信制・中央国際高等学校の学費部分については、高等学校等就学支援金の制度対象となる場合があります。対象条件や手続きの詳細は、事務局とお住まいの自治体にご確認ください。",
  },
];
