...
export const metadata: Metadata = {
  title: {
    absolute: "JRA厩務員、騎手・競馬学校を目指す高校｜募集要項・学費｜東関東馬事高等学院",
  },
  description:
    "JRA厩務員課程・騎手課程、競馬学校を目指す中学生・高校生へ。東関東馬事高等学院の募集要項、出願資格、学費、入学までの流れをご案内。未経験から馬の騎乗・飼養管理を学び、高校3年次には在学しながらJRA競馬学校 厩務員課程の受験にも挑戦できます。",
  keywords: [
    "JRA厩務員",
    "競馬学校",
    "JRA競馬学校",
