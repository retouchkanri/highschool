...
export const metadata: Metadata = {
  title: {
    absolute: "馬の高校・馬の学校｜乗馬・競走馬を学ぶ 東関東馬事高等学院（公式）",
  },
  description:
    "馬の高校・馬の学校を比較している中学生・高校生へ。東関東馬事高等学院（バジガク）は、乗馬・競走馬・JRA厩務員・騎手・牧場など馬の仕事を学べる全寮制の高校です。乗馬クラブとは違い、毎日たっぷり馬の授業。馬と共に学び、高校卒業と馬業界への進路を目指せる馬の学校です。",
  keywords: [
    "馬の高校",
    "馬の学校",
    "馬を学べる高校",
