...
export const metadata: Metadata = {
  title: {
    absolute: "高校から馬術・乗馬を本格的に学ぶ｜馬術大会に挑戦｜東関東馬事高等学院",
  },
  description:
    "乗馬未経験から馬術を学べる高校。日々の騎乗授業で基礎から障害飛越まで学び、馬術競技会への出場にも挑戦。馬と共に成長できる高校生活をご紹介します。総合馬術・障害馬術、競技参加費用は全額学校負担。馬術競技選手を目指すなら東関東馬事高等学院。バジガクの馬術選手、馬術部。",
  keywords: [
    "馬術 高校",
    "乗馬 高校",
    "乗馬を学べる高校",
