...
export const metadata: Metadata = {
  title: "JRA・地方競馬騎手を目指す方へ（騎手受験特別コース）",
  description:
    "JRA競馬学校・地方競馬教養センターの騎手課程合格を目指す「騎手受験特別コース」。騎手を目指す理由から、9つの受験対策、卒業までのロードマップ、開校以来12年間38名の合格実績、在校生の声まで。合格保証制度と単位引き継ぎのセーフティネットで、本気の挑戦を支えます。",
};
