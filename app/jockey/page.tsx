...
export const metadata: Metadata = {
  title: {
    absolute: "騎手になるには｜JRA競馬学校・騎手を高校から目指す｜東関東馬事高等学院",
  },
  description:
    "JRA騎手・地方競馬騎手を目指す中学生へ。騎手になるための騎乗訓練、体力・体重管理、学科・面接対策まで、高校生活を通して騎手試験合格を目指します。中学生のための騎手課程受験事前合宿。騎手課程受験内容を徹底解説。夏休み騎手受験合宿を開催。中学3年生の騎手受験合宿なら。",
  keywords: [
    "騎手になるには",
    "騎手 高校",
    "JRA騎手",
