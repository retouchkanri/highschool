...
export const metadata: Metadata = {
  title: {
    absolute: "不登校から馬の高校へ｜転入学・転校（今すぐ対応）｜東関東馬事高等学院",
  },
  description:
    "不登校経験があっても、馬と過ごす環境から高校生活を再スタート。全寮制の環境と馬との実践授業を通じて、高校卒業とその先の進路をサポートします。転入学、馬が好きなら。ホースセラピー。乗馬クラブで学ながら高校の卒業資格を取得できる感覚。バジガクで高校卒業資格を取得",
  keywords: [
    "不登校 高校",
    "不登校 全寮制高校",
    "馬の高校",
