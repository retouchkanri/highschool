...
export const metadata: Metadata = {
  title: {
    absolute: "不登校からの高校進学・転入｜馬と学ぶ全寮制高校｜東関東馬事高等学院／ホースセラピー高校／全寮制の高校",
  },
  description:
    "不登校からの高校進学、高校からの転入・転校を考えている方へ。東関東馬事高等学院では、中学校までの出席日数や成績だけで判断せず、これからの意欲を大切にしています。通信制高校の仕組みと全寮制・全室個室の環境、担当馬との毎日を通じて、一人ひとりの高校生活の再スタートを支えます。",
  keywords: [
    "不登校",
    "不登校高校",
    "不登校高校進学",
