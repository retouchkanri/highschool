...
export const metadata: Metadata = {
  title: {
    absolute: "競走馬の牧場で働くには｜高校から牧場就職を目指す｜東関東馬事高等学院",
  },
  description:
    "競走馬の生産牧場・育成牧場で働きたい高校生へ。馬の管理、騎乗、飼養管理を学び、全国の牧場インターンシップを通じて馬の仕事への就職を目指します。牧場へのインターンシップ、アルバイト。働きながら学ぶ、学びながら働く。自分に一番合った牧場を選び出すことができますと。",
  keywords: [
    "牧場で働く",
    "競走馬 牧場",
    "牧場 就職",
