...
export const metadata: Metadata = {
  title: {
    absolute: "大学・短大・専門学校への進学｜馬の高校から進学を目指す｜東関東馬事高等学院",
  },
  description:
    "馬の高校から、大学・短大・専門学校への進学を目指す方へ。東関東馬事高等学院は広域通信制・中央国際高等学校との連携により、全日制と同じ高校卒業資格を取得できます。馬術競技の実績を活かした大学馬術部へのスポーツ推薦進学から、一般入試・総合型選抜での進学、一般企業への就職まで。3年間の学びを、その先の進路につなげます。",
  keywords: [
    "通信制高校進学",
    "大学進学",
    "短大進学",
