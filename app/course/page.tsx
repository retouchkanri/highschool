...
export const metadata: Metadata = {
  title: {
    absolute: "学校紹介｜乗馬・JRA厩務員・騎手｜東関東馬事高等学院（通称：バジガク）",
  },
  description:
    "関東・関西で有名な馬事学院では、「乗馬、競走馬、JRA厩務員、騎手を目指せる馬の高校」として、千葉県山武市にある馬の高校。通信制高校との連携で、全寮制で毎日馬を学べる馬の高校です。一人ひとりの目標に合わせて馬の仕事や進学を目指せるコースをご紹介します。",
  keywords: [
    "馬を学べる高校",
    "馬の高校",
    "乗馬高校",
