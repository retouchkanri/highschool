...
export const metadata: Metadata = {
  title: {
    absolute: "株式会社 馬事学院｜学校概要｜馬の高校 東関東馬事高等学院（バジガク）",
  },
  description:
    "東関東馬事高等学院は、馬と共に学びながら高校卒業資格取得を目指す全寮制の馬の高校です。学校所在地、教育方針、施設などをご案内します。株式会社馬事学院（学費の滞納など、災害救済制度など豊富、授業費分割ローン、学費、滞納など問題解決、ご相談ください）馬事学院なら",
  keywords: [
    "東関東馬事高等学院",
    "バジガク",
    "馬の高校",
