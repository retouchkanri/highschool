...
export const metadata: Metadata = {
  title: {
    absolute: "引退競走馬を学べる高校｜馬の保護・セカンドキャリア｜東関東馬事高等学院",
  },
  description:
    "引退競走馬の保護、飼養管理、再調教、セカンドキャリアについて実践的に学ぶ馬の高校。馬の命と向き合い、引退馬を支える仕事や活動を学びます。引退馬保護のRetouch「リタッチ」との連携で、引退した競走馬に関り、馬の保護トレーニング方法を学べます。在籍馬120頭以上の馬の高校",
  keywords: [
    "引退競走馬",
    "引退馬",
    "馬の保護",
