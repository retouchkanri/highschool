...
export const nav: NavItem[] = [
  ...
  { label: "学校見学", href: "/opencampus", en: "OPEN CAMPUS" },
  {
    ...
    children: [
      ...
      { label: "競走馬の牧場を目指す方へ", href: "/bokujo" },
      { label: "馬術競技会出場を目指す方へ", href: "/bajutsu" },
      { label: "引退馬のサポートを目指す方へ", href: "/intaiba" },
      { label: "短大・専門学校・大学進学へ", href: "/shingaku" },
